...
public class ProgramState {
    ...
    public ProgramState(IADTStack<IStatement> executionStack, IADTDictionary<String, IValue> symTable, IADTList<String> out) {
    ...
    public ProgramState oneStep() throws GeneralException {
        if (executionStack.isEmpty()) {
            throw new GeneralException("Execution Stack Error: Execution stack is empty when attempting to execute one step.");
        }
    ...
    public String toString() {
        return String.format("------EXE_STACK------\n%s\n------SYM_TABLE------\n%s\n------OUT------\n%s\n", executionStackToString(), symTableToString(), outToString());
    }
}
