    ...
    public IType typeCheck(IADTDictionary<String, IType> typeTable) throws ExpressionException {
        ...
        if (type1.equals(new IntType())) {
            if (type2.equals(new IntType())) {
                ...
                throw new ExpressionException("Expression Exception: The second operand is not an integer.");
            }
        } else {
            throw new ExpressionException("Expression Exception: The first operand is not an integer.");
        }
    }
