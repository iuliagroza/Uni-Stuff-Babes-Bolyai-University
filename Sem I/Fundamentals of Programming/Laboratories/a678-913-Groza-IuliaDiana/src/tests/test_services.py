...
class TestServices(unittest.TestCase):
    ...
    def test_add_student(self):
        ...
        self.assertEqual(self._student_services.students, [p1, p2, p3])
    ...
    def test_add_discipline(self):
        ...
        self.assertEqual(self._discipline_services.disciplines, [p1, p2, p3])
    ...
    def test_add_grade(self):
        ...
        self.assertEqual(self._grade_services.grades, [g1, g2, g3, g4, g5])
    ...
    def test_remove_student(self):
        ...
        self.assertEqual(self._student_services.students, [p1, p2, p3, p4, p5])
        self.assertEqual(self._student_services.grades, [g1])

        with self.assertRaises(NotFoundError):
            self._student_services.remove_student(5)

        self._student_services.remove_student(4)
        self.assertEqual(self._student_services.students, [p1, p2, p3, p5])
        self.assertEqual(self._student_services.grades, [g1])

        self._student_services.remove_student(6)
        self.assertEqual(self._student_services.students, [p1, p2, p3])
        self.assertEqual(self._student_services.grades, [])
    ...
    def test_remove_discipline(self):
        ...
        self.assertEqual(self._discipline_services.disciplines, [p1, p2, p3, p4, p5])
        self.assertEqual(self._discipline_services.grades, [g1, g2, g3, g4])

        with self.assertRaises(NotFoundError):
            self._discipline_services.remove_discipline(4)

        self._discipline_services.remove_discipline(6)
        self.assertEqual(self._discipline_services.disciplines, [p1, p2, p3, p4])
        self.assertEqual(self._discipline_services.grades, [g3])

        self._discipline_services.remove_discipline(2)
        self.assertEqual(self._discipline_services.disciplines, [p1, p3, p4])
        self.assertEqual(self._discipline_services.grades, [])
    ...
    def test_update_student(self):
        ...
        self.assertEqual(self._student_services.students, [p1, p2, p3, p4])
    ...
    def test_search_by_id_stud(self):
        ...
        self.assertEqual(self._student_services.search_by_id(1), [p1, p2, p3, p4])
        self.assertEqual(self._student_services.search_by_id(19), [])
    ...
    def test_search_by_name_stud(self):
        ...
        self.assertEqual(self._student_services.search_by_name("aNA"), [p1, p2, p3, p4])
        self.assertEqual(self._student_services.search_by_name("anastasia"), [])
    ...
    def test_search_by_id_disc(self):
        ...
        self.assertEqual(self._discipline_services.search_by_id(1), [p1, p2, p3, p4])
        self.assertEqual(self._discipline_services.search_by_id(19), [])
    ...
    def test_search_by_name_disc(self):
        ...
        self.assertEqual(self._discipline_services.search_by_name("MAt"), [p1, p2, p3, p4])
        self.assertEqual(self._discipline_services.search_by_name("Mathematics"), [])
    ...
    def test_discipline_undo_redo(self):
        ...
        self.assertEqual(self._discipline_services.disciplines, [p2, p3])

        self._discipline_services.undo()
        self.assertEqual(self._discipline_services.disciplines, [p2, p1])

        self._discipline_services.undo()
        self.assertEqual(self._discipline_services.disciplines, [p1])

        self._discipline_services.undo()
        self.assertEqual(self._discipline_services.disciplines, [])
        ...
        self._discipline_services.redo()
        self.assertEqual(self._discipline_services.disciplines, [p1, p2])

        self._discipline_services.redo()
        self.assertEqual(self._discipline_services.disciplines, [p3, p2])

        self._discipline_services.redo()
        self.assertEqual(self._discipline_services.disciplines, [p2])
