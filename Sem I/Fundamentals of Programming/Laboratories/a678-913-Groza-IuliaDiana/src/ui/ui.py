...
class UI:
    def __init__(self, student_services, discipline_services, grade_services):
    ...
    def print_stats_results_two(results):
        ...
        """
        for result in results:
            if results[result] == -1.00:
                print(f"Student ID: {result[0]}; Student Name: {result[1]}; Aggregated average: Not graded yet")
            else:
                print(
                    f"Student ID: {result[0]}; Student Name: {result[1]}; Aggregated average: {'{:.2f}'.format(results[result])}")
    ...
    def print_stats_results_three(results):
        ...
        for result in results:
            if results[result] == -1.00:
                ...
                print(f"Discipline ID: {result[0]}; Discipline Name: {result[1]}; Average: {'{:.2f}'.format(results[result])}")
