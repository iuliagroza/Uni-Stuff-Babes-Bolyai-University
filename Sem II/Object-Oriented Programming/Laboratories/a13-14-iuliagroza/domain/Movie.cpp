...
Movie::Movie(std::string title, std::string genre, int year_of_release, int number_of_likes, std::string trailer)
        : title{std::move(title)}, genre{std::move(genre)}, year_of_release{year_of_release}, number_of_likes{number_of_likes},
          trailer{std::move(trailer)} {}

Movie::Movie() : year_of_release(0), number_of_likes(0) {}
...
std::string Movie::to_str() {
    ...
    output << this->title << "; ";
    output << this->genre << "; ";
    output << this->year_of_release << "; ";
    output << this->number_of_likes << "; ";
    output << this->trailer;
