#ifndef A11_12_IULIAGROZA_USERREPOSITORY_H
#define A11_12_IULIAGROZA_USERREPOSITORY_H
...
public:
    ...
    /*
     * Function that returns the position of the element from the watchlistlist that equals movie. If movie is not found,
     * -1 is returned.
     * :movie: Movie object
     * return: integer (the position of movie in this->movie or -1)
     */
    int find(Movie movie);
