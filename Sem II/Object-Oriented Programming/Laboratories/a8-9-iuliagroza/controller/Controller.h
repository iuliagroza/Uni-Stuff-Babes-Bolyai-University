...
public:
     ...
     * CONSTRUCTOR
     */
    Controller(std::string admin_filename, UserRepository *r);
     ...
     * return: bool
     */
    void update_admin(Movie movie, Movie new_movie);
