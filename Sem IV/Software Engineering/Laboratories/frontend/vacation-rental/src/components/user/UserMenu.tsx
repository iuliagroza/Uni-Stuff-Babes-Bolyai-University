        ...
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="static" sx={{ marginBottom: "20px", backgroundColor: colors.pink[500] }}>
                <Toolbar>
                    ...
                    {isBigScreen && <Button
                        variant={path.startsWith("/public-dest/view") ? "outlined" : "text"}
                        to="/public-dest/view"
                        component={Link}
                        color="inherit"
                        sx={{ mr: 4 }}
                    ...
                    {isBigScreen && <Button
                        variant={path.startsWith("/bucket-list/view") ? "outlined" : "text"}
                        to="/bucket-list/view"
                        component={Link}
                        color="inherit"
                        sx={{ mr: 4 }}
                    ...
                    {isBigScreen && <Button
                        variant={path.startsWith("/bucket-list/add") ? "outlined" : "text"}
                        to="/bucket-list/add"
                        component={Link}
                        color="inherit"
                        sx={{ mr: 4 }}
                    ...
                    >
                        ...
                        >
                            ...
                            <Box sx={{ mb: 2 }}>
                                <ListItemButton to="/public-dest/view" component={Link}>
                                    <ListItemText primary="Destinations" />
                                </ListItemButton>

                                <ListItemButton to="/bucket-list/view" component={Link}>
                                    <ListItemText primary="Bucket List" />
                                </ListItemButton>

                                <ListItemButton to="/bucket-list/add" component={Link}>
