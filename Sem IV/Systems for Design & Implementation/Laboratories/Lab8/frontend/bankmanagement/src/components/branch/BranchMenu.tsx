        ...
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="static" sx={{ marginBottom: "20px", backgroundColor: colors.pink[500] }}>
                <Toolbar>
                    ...
                    {isBigScreen && <Button
                        variant={path.startsWith("/branch") ? "outlined" : "text"}
                        to="/branch"
                        component={Link}
                        color="inherit"
                        sx={{ mr: 4 }}
                    ...
                    {isBigScreen && <Button
                        variant={path.startsWith("/branch/add") ? "outlined" : "text"}
                        to="/branch/add"
                        component={Link}
                        color="inherit"
                        sx={{ mr: 4 }}
                    ...
                    >
                        ...
                        >
                            ...
                            <Box sx={{ mb: 2 }}>
                                <ListItemButton to="/branch" component={Link}>
                                    <ListItemText primary="Branches" />
                                </ListItemButton>

                                <ListItemButton to="/branch/add" component={Link}>
