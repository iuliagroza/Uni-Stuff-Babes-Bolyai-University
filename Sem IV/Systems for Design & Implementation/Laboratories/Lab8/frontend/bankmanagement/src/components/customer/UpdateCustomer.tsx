import { Button, Card, CardActions, CardContent, Container, CssBaseline, FormLabel, IconButton, TextField, colors } from "@mui/material";
        ...
        <React.Fragment>
            ...
            <Card>
                ...
                <CardActions sx={{ justifyContent: "center" }}>
                    <Button type="submit" onClick={updateCustomer} variant="contained" sx={{ backgroundColor: colors.pink[500] }}>Update customer</Button>
