...
def main(dataset_path):
    ...
    for _, row in dataset.iterrows():
        text, true_entity, timestamp = row['Text'], row['When'], row['Timestamp']
        who, what = row['Who'], row['What']
        predicted_entity = extract_most_relevant_time(text, timestamp, who, what)
    ...
    print("Evaluation of \"When?\" extraction:")
